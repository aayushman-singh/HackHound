...
async def fuzz(data: FuzzRequest):
    ...
    if actions.get("fuzz_directory"):
        dir_wordlist = "app/config/wordlists/dir_wordlist.txt"
    ...
    if actions.get("fuzz_subdomain") and domain:
        sub_wordlist = "app/config/wordlists/subdomains.txt"
    ...
    if actions.get("fuzz_vhost") and domain:
        vhost_wordlist = "app/config/wordlists/vhosts.txt"
    ...
    if actions.get("fuzz_api"):
        params = {'id': '1'}
        api_wordlist = "app/config/wordlists/api_endpoints.txt"
